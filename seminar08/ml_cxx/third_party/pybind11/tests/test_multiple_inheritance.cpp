...
TEST_SUBMODULE(multiple_inheritance, m) {
    ...
    // template parameters because src has to know the types involved; see discussion in #742 for
    // details).
...
//        .def(py::init<int, int>());
    ...
    // Return a base class pointer to a src-registered type when the actual derived type
    // isn't src-registered (and uses multiple-inheritance to offset the src base)
